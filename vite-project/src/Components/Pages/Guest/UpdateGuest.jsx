  ...
  return (
    <div>
       <div className="container -translate-y-[560px] translate-x-[500px] shadow shadow-slate-300 w-[500px]  h-[470px] bg-slate-200">
        ...
        <h2 className='text-4xl text-center font-bold uppercase'>Update Guest</h2>
        <form className=''>
                ...
                <input type="Number" placeholder='Phone' className='ml-2 px-5 p-2 mt-2 outline-none' required />
