    ...
    <div>
       <div className="container -translate-y-[560px] translate-x-[500px] shadow shadow-slate-300 w-[500px]  h-[470px] bg-slate-200">
        ...
        <form className=''>
                ...
                <input type="Date" placeholder='checkinData' className='ml-2 px-5 p-2  outline-none' required />
                <input type="Date" placeholder='checkoutData' className='ml-[109px] px-5 p-2 mt-2 outline-none' required />
