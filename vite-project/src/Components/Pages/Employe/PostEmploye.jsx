    ...
    <div>
       <div className="container -translate-y-[530px] translate-x-[500px] shadow shadow-slate-300 w-[500px]  h-[400px] bg-slate-200">
        ...
        <form className=''>
                ...
                <input type="" placeholder='Phonee' className='ml-2 px-5 p-2  outline-none' required />
                <input type="text" placeholder='Position' className='ml-2 px-5 p-2  outline-none' required />
                <input type="text" placeholder='Salery' className='ml-2 px-5 p-2  outline-none' required />
                <input type="text" placeholder='Hotel_id' className='ml-2 px-5 p-2  outline-none' required />
